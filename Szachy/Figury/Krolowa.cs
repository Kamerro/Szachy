...
{
    public class Krolowa : AFigury, ICloneable
    {
        public  Krolowa(int x, int y, Image image, bool isOnBlack, bool isBlack) : base(x, y, image, isOnBlack, isBlack)
        {
        }
        ...
        {
            var clone = (Krolowa)this.MemberwiseClone();
            return clone;
        }
